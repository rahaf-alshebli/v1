            ...
            <div class="container text-center pb-5">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb justify-content-center text-uppercase">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page">GYM&Yoga</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="w-100" src="img/yoga2.jpg" alt="Image">
            ...
            <div class="carousel-item">
                <img class="w-100" src="img/yoga1.jpg" alt="Image">
            ...
            <div class="carousel-item">
                <img class="w-100" src="img/yoga3.jpg" alt="Image">
            ...
            <div class="carousel-item">
                <img class="w-100" src="img/yoga4.jpg" alt="Image">
                <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                    <div class="p-3" style="max-width: 700px;">
                        <h6 class="section-title text-white text-uppercase mb-3 animated slideInDown">Luxury Living</h6>
                        <h1 class="display-3 text-white mb-4 animated slideInDown">Explore your Dream Room</h1>
...
<div class="container-xxl py-5">
    <div class="container">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6">
                <h6 class="section-title text-start text-primary text-uppercase">GYM&Yoga</h6>
                <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">UNIHOUSE  </span>"GYM&Yoga"</h1>

...
@section('content')
    ...
    <!-- Page Header Start -->
    <div class="container-fluid page-header mb-5 p-0" style="background-image: url(https://live.staticflickr.com/1363/537809966_79f9f640f7_b.jpg);">
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">UNI HOUSE </span></h1>
                    <p class="mb-4">We help you choose your comfortable accommodation near your university, and if you are an expat student or your home is far from your university, I will save you the hassle of going out and looking for your own accommodation.</p>

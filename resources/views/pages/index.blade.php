        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="w-100" src="img/image.png" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 700px;">
                            <h6 class="section-title text-white text-uppercase mb-3 animated slideInDown">Luxury Living</h6>
                            <h1 class="display-3 text-white mb-4 animated slideInDown">Explore your Dream Room</h1>
                ...
                <div class="carousel-item">
                    <img class="w-100" src="img/image (3).png" alt="Image">
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 700px;">
                            <h6 class="section-title text-white text-uppercase mb-3 animated slideInDown">Luxury Living</h6>
                            <h1 class="display-3 text-white mb-4 animated slideInDown">Explore your Dream Room</h1>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    ...
                    <h1 class="mb-4">Welcome to <span class="text-primary text-uppercase">UNIHOUSE</span></h1>
                    <p class="mb-4">At UNIHOUSE every stay is a story.  We want you to have a calm and comfortable environment that helps you study well, do your best and develop your skills..
                    </p>
                ...
                <div class="col-lg-6">
                    <div class="row g-3">
                        <div class="col-6 text-end">
                            <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s" src="img/R (2).jfif"
                                style="margin-top: 25%;">
                        </div>
                        <div class="col-6 text-start">
                            <img class="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.3s" src="img/537809966_79f9f640f7_b.jpg">
                        </div>
                        <div class="col-6 text-end">
                            <img class="img-fluid rounded w-50 wow zoomIn" data-wow-delay="0.5s" src="img/cef5090adac3d25dee7d375724c2cdbe.jpg">
                        </div>
                        <div class="col-6 text-start">
                            <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.7s" src="img/fa9a73a8153f8dc3dd74cbd8bd712e28.jpg">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-0">
            <div class="col-md-6 bg-dark d-flex align-items-center">
                <div class="p-5">
                    ...
                    <h1 class="text-white mb-4">Explore your Dream Room</h1>
            ...
            <div class="modal-content rounded-0">
                ...
                <div class="modal-body">
                    ...
                    <div class="ratio ratio-16x9">
                        <iframe width="916" height="515" src="https://www.bing.com/videos/search?q=Explore+your+Dream+Room+IN+university&&view=detail&mid=CD5416FCAB42E85BAF90CD5416FCAB42E85BAF90&&FORM=VRDGAR&ru=%2Fvideos%2Fsearch%3Fq%3DExplore%2520your%2520Dream%2520Room%2520IN%2520university%26qs%3Dn%26form%3DQBVRMH%26%3D%2525e%25D8%25A5%25D8%25AF%25D8%25A7%25D8%25B1%25D8%25A9%2520%25D9%2585%25D8%25AD%25D9%2581%25D9%2588%25D8%25B8%25D8%25A7%25D8%25AA%2520%25D8%25A7%25D9%2584%25D8%25A8%25D8%25AD%25D8%25AB%2525E%26sp%3D-1%26pq%3Dexplore%2520your%2520dream%2520room%2520in%2520universit%26sc%3D0-36%26sk%3D%26cvid%3DBB7C045B13414152B2424647ADB0536D%26ghsh%3D0%26ghacc%3D0%26ghpl%3D"
                ...
                @foreach ($array as $item)
                    <div class="testimonial-item position-relative bg-white rounded overflow-hidden">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded" src="img/image.png"

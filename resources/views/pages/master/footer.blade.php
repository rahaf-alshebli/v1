        ...
        <div class="row g-5">
            <div class="col-md-6 col-lg-4">
                <div class="bg-primary rounded p-4">
                    <a href="index.html">
                        <h1 class="text-white text-uppercase mb-3">UNI HOUSE</h1>
                    </a>
                    <p class="text-white mb-0">
                        <a class="text-dark fw-medium" href="index">UNI HOUSE</a>, every stay is a story. And
            ...
            <div class="col-md-6 col-lg-3">
                ...
                <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>60 Street, AL-Salt, Jordan</p>
                <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+962777786839</p>
                <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@UNIHOUSE.com</p>
        ...
        <div class="copyright">
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a class="border-bottom" href="#">UNI HOUSE</a>, All Right Reserved.

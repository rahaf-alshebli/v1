                             ...
                             <div class="col-md-3">
                                <select name="beds" class="form-control">
                                    <option  disabled="">Select a university</option>
                                        <option value="1">university of jordan </option>
                                        <option value="2">balqa applied university</option>
                                        <option value="3">hashemite university</option>
                                        <option value="4">Jordan University of Science and Technology</option>
                                        <option value="5">yarmouk university </option>
